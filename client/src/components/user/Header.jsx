                ...
                <Collapse in={expanded}>
                    ...
                    >
                        ...
                        <Nav className="ms-md-auto flex-column flex-md-row">
                            <Nav.Link as={Link} to="/" className="text-dark me-md-4 mb-2 mb-md-0" style={{ fontWeight: "600", letterSpacing: "0.5px", fontSize: "13px" }}>
                                HOME
                            </Nav.Link>
                            <Nav.Link as={Link} to="/all-cars" className="text-dark me-md-4 mb-2 mb-md-0" style={{ fontWeight: "600", letterSpacing: "0.5px", fontSize: "13px" }}>
                                CARS
                            </Nav.Link>
                            <Button
                                as={Link}
