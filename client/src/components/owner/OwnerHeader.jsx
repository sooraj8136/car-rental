...
function OwnerHeader() {
    ...
    return (
        <Navbar bg="white" expand="md" expanded={expanded} fixed="top" style={{ minHeight: '70px' }}>
            <Container className="d-flex align-items-center justify-content-between">
                {/* Logo + Brand */}
                <div className="d-flex align-items-center">
                    <Navbar.Brand as={Link} to="/owner/owner-dashboard" className="d-flex align-items-center me-2 mb-0">
                        <img
                            src={logo}
                            alt="Lucent Mobility"
                            style={{
                    ...
                    <p
                        ...
                        style={{
                            fontSize: "14px",
                            fontWeight: "600",
                            lineHeight: "1",       // aligns vertically with logo
                            whiteSpace: "nowrap",
                            marginLeft: "6px",
                        }}
                    >
                ...
                <Collapse in={expanded}>
                    ...
                    >
                        ...
                        <Nav className="ms-md-auto flex-column flex-md-row">
                            <Nav.Link as={Link} to="/owner/owner-dashboard" className="text-dark me-md-4 mb-2 mb-md-0" style={{ fontWeight: "600", letterSpacing: "0.5px", fontSize: "13px" }}>
                                DASHBOARD
                            </Nav.Link>
                            <Nav.Link as={Link} to="/owner/owner-cars" className="text-dark me-md-4 mb-2 mb-md-0" style={{ fontWeight: "600", letterSpacing: "0.5px", fontSize: "13px" }}>
                                CARS
                            </Nav.Link>
                            <Nav.Link as={Link} to="/owner/pending-req" className="text-dark me-md-4 mb-2 mb-md-0" style={{ fontWeight: "600", letterSpacing: "0.5px", fontSize: "13px" }}>
                                REQUESTS
                            </Nav.Link>
                            <Nav.Link as={Link} to="/owner/profile" className="text-dark me-md-4 mb-2 mb-md-0" style={{ fontWeight: "600", letterSpacing: "0.5px", fontSize: "13px" }}>
                                ACCOUNT
                            </Nav.Link>
                        </Nav>
